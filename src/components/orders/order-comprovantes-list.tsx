...
/**
 * OrderComprovantesList — espelho de ComprovantesList do Freelances.
 *
 * Renderizada DENTRO do card "Repasses ao cliente" em Pedidos. Se não houver
 * comprovantes, não renderiza (botão "Comprovante" no header já orienta).
 */

import { useTransition } from 'react'
import { toast } from 'sonner'
import { deleteOrderFile, createOrderFileSignedUrl } from '@/lib/actions/order-files'
...
export function OrderComprovantesList({
  files,
  ...
  async function handleDelete(f: OrderFile) {
